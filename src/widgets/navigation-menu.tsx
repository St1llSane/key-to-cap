...
const navigationMenuTriggerStyle = cva(
  'group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 text-sm font-medium transition-colors focus:text-secondary_dark-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50'
)
